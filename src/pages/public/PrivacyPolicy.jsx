            ...
            <div className="space-y-6 text-justify" style={{ color: textGray }}>
                <section>
                    ...
                    <p>
                        ...
                        Đối với đăng nhập bằng Google, chúng tôi chỉ thu thập tên, email và ảnh đại diện công khai của bạn để tạo hồ sơ người dùng.
                    </p>
                </section>
                ...
                <section>
                    <h2 className="text-xl font-semibold mb-3" style={{ color: brandBrown }}>3. Bảo mật thông tin</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-semibold mb-3" style={{ color: brandBrown }}>4. Chia sẻ thông tin</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-semibold mb-3" style={{ color: brandBrown }}>5. Quyền của bạn</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-semibold mb-3" style={{ color: brandBrown }}>6. Liên hệ</h2>
                    <p>
