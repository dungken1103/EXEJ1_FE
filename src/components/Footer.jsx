        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2" style={{ color: creamText }}>
              ...
              <li className="flex items-center"><MdPhone className="mr-2 flex-shrink-0" /> +84 395 133 868</li>
              <li className="flex items-center"><MdEmail className="mr-2 flex-shrink-0" /> wtwwastetoworth@gmail.com</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 text-xl mb-4" style={{ color: creamText }}>
              <a href="https://www.facebook.com/share/1AbgG3huUm/?mibextid=wwXIfr" className="hover:text-white transition"><FaFacebookF /></a>
            </div>
            <p className="font-semibold text-sm mb-1" style={{ color: cream }}>
              Waste To Worth
            </p>
            <p style={{ color: creamText }} className="text-sm">
              Trao vòng đời mới cho những mảnh gỗ offcut. Upcycling gỗ thừa thành sản phẩm decor bền vững và độc bản.
            </p>
          </div>
        </div>
